...
3. SUBTLE ROLE INDICATION: DO NOT directly say "I'm looking for a Software Engineer role". Instead:
   ...
   - Example: Instead of "seeking Mainframe Developer role", say "my work in building secure systems..."
...
8. FORMATTING:
   ...
   - Example: "I've worked with **Mainframe** and **Cobol**" or "built **secure systems**"
